...
export class Backend implements backendInterface {
    ...
    async getAllVolunteerApplications(): Promise<Array<VolunteerApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVolunteerApplications();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async postComment(arg0: bigint, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.postComment(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async postStory(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitVolunteerApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVolunteerApplication(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
